...
f_catalog_p = # Halo directory here (one for each neutrino mass) eg. '/.../Mn_p/halos/0/out_4_pid.list'
f_catalog_pp = # Halo directory here eg. '/.../Mn_pp/halos/0/out_4_pid.list'
f_catalog_ppp = # Halo direrctory here eg. '/.../Mn_ppp/halos/0/out_4_pid.list'
