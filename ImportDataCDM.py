...
# input files
snapshot = #particle data directory here eg. '/.../snapdir_004/snap_004'
...
delta *= Masses[1]
# check that the mass in the density field is equal to the total mass in the density
...
# consider the particles in that slide
...
# delta contains the effective number of particles in each voxel
